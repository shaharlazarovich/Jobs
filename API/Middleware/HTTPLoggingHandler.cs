...
{
    //this class logs our requests going through the pipeline - it logs the URL, correlation id etc.
    ...
    private static class Log
    {
        ...
        private static string GetCorrelationIdFromRequest(HttpRequestMessage request)
        {
            ...
            if (request.Headers.TryGetValues("EDRM-Correlation-ID", out var values))
            {
